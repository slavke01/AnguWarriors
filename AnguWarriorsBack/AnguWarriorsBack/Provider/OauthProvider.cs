...
namespace AnguWarriorsBack.Provider
{
  public class OauthProvider: OAuthAuthorizationServerProvider
  {
    ...
    {
      //First request will come here, this method will validate the request wheather it
      // has crendtials(UserName and Password) if the request not contain username and   
